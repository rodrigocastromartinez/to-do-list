...
export default function MembersModal({ projectId, onCloseModal }: MembersModalParams) {
    ...
    return <>
    <div className="fixed top-0 left-0 h-screen w-screen bg-[var(--black-transparent)] flex flex-col gap-4 justify-center items-center z-30 " onClick={onCloseModal} >
